...
def _remap_advanced_field_config(src_field, mapping: dict) -> Tuple[dict, List[str]]:
    ...
    return (
        dict(
            ...
            table_match_prompt=_remap(src_field.table_match_prompt),
...
async def copy_configs(
    ...
    for src in src_fields:
        ...
        new_field = ExtractionField(
            ...
            empty_retry_enabled=bool(getattr(src, "empty_retry_enabled", False)),
            empty_retry_count=getattr(src, "empty_retry_count", None) or 2,
            ...
            table_match_prompt=src.table_match_prompt,
