...
class File(Base):
    ...
    start_extracting_time: Mapped[datetime | None] = mapped_column(DateTime, nullable=True)
    end_extracting_time: Mapped[datetime | None] = mapped_column(DateTime, nullable=True)
    start_analyzing_time: Mapped[datetime | None] = mapped_column(DateTime, nullable=True)
...
class ExtractionField(Base):
    ...
    # 文本类专用
      search_type: Mapped[str | None] = mapped_column(
          Enum("context", "section", "rule", "chunk_db", "vector_db", "page", "hybrid", name="search_type_enum"),
        nullable=True,
    )
